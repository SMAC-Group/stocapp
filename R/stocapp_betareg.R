...
stocapp.betareg <- function(object, thetastart=NULL, control=list(...), ...){
...
#' @export
setMethod("stocapp", className("betareg", "betareg"),
          definition = stocapp.betareg)
...
#' @description simulation method for class \linkS4class{StocappBetareg}
