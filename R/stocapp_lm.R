...
stocapp.lm <- function(object, thetastart=NULL, control=list(...), extra_param = FALSE, ...){
  # controls
...
#' @export
setMethod("stocapp", signature = className("lm","stats"),
          definition = stocapp.lm)
...
#' @description simulation method for class \linkS4class{StocappLm}
