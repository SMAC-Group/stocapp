...
stocapp.vglm <- function(object, thetastart=NULL, control=list(...), extra_param = FALSE,...){
  # controls
...
#' @export
setMethod("stocapp", className("vglm", "VGAM"),
          definition = stocapp.vglm)
...
#' @description simulation method for class \linkS4class{StocappVglm}
