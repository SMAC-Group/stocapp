...
stocapp.glm <- function(object, thetastart=NULL, control=list(...), extra_param = FALSE, ...){
...
#' @export
setMethod("stocapp", className("glm", "stats"),
          definition = stocapp.glm)
...
# stocap.negbin (MASS)
stocapp.negbin <- stocapp.glm

#' \code{\link{stocapp}} method for \code{negbin} object
#' from \code{\link[MASS]{glm.nb}} function of \pkg{MASS}
#' package.
#' @inheritParams stocapp,glm-method
#' @export
setMethod("stocapp", signature = "negbin",
          definition = stocapp.negbin)
...
#' @description simulation method for class \linkS4class{StocappNegbin}
